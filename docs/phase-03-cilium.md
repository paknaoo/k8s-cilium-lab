...
Hubble was not enabled as part of this phase. It is documented separately in [Phase 04 — Hubble Observability](phase-04-hubble.md).

Network policy enforcement and WireGuard management connectivity were implemented and validated in later completed phases.
